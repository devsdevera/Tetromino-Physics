...
public class Game {
  ...
  public void moveLeft() {
    active.moveLeft();						// changed from moveRight to moveLeft. was identical to moveRight
   ...
   * */
  public void landing() {
	  while(activeValid()) {	// while valid move down
		  active.moveDown();
	  }
	  if(!activeValid()){ active.moveUp(); }	// likely it will be invalid, go back
  }
